        ...
        <Router>
          <Layout>
            <Routes>
              ...
              <Route path="/library/studentList" element={<StudentList />} />
              <Route path="/library/employeeList" element={<Employees />} />
              <Route
              ...
              <Route path="/library/past/issues" element={<PastIssues />} />
              <Route path="/library/members" element={<Members />} />
              <Route path="/library/categories" element={<BookCategory />} />
              <Route path="/library/book-racks" element={<BookRack />} />
              <Route path="/library/book-author" element={<BookAuthors />} />
              <Route
                path="/library/book-publisher"
                element={<BookPublisher />}
              />
              <Route path="/library/books/books-list" element={<BookList />} />
              <Route
              ...
              />
              <Route path="/transportation/routes" element={<ManageRoutes />} />
              <Route
