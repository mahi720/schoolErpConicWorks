...
import BookCategoryEditModal from "../../components/library/BookCategoryEditModal";
...
export default function BookCategory() {
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
        <h2 className="text-xl text-white mb-5">Book Category List</h2>
        ...
        <table className="w-full">
          <thead className="border-y border-gray-800">
            <tr>
              ...
              <th className="p-3 text-gray-300">Book Category Name</th>
              ...
              >
                ...
                <td className="p-3">
                  <div className="flex justify-center gap-3">
                    ...
                    <button
                      onClick={() => deleteBookCategory(item.id)}
      ...
      <BookCategoryEditModal
        open={open}
        close={() => setOpen(false)}
        data={editData}
        update={updateBookCategory}
      />
    </div>
  );
}
