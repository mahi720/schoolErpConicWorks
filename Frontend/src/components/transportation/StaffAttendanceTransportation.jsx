...
const StaffAttendanceTransportation = () => {
  ...
  const staffs = [
    ...
    { id: 2, name: "Suresh Kumar", mobile: "9876501234" },
  ];

  // Generate attendance data for each staff per month
  ...
  const [attendanceData] = useState(() => {
    ...
    staffs.forEach((staff) => {
      data[staff.id] = {
        pickup: generateAttendance(staff.id, 7, 2026),
        drop: generateAttendance(staff.id, 7, 2026),
      };
    });
    return data;
  });
    ...
    <div className="bg-gray-800 rounded-xl border border-gray-700 p-5">
      ...
      <div className="flex items-center justify-between border-b border-gray-700 pb-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-white font-semibold">Staffs Attendance</h2>
        </div>
      ...
      <div className="overflow-x-auto custom-scrollbar">
        <div className="min-w-[1350px] max-h-[450px] overflow-y-auto custom-scrollbar">
          ...
          <div className="space-y-1">
            {staffs.map((staff) => {
              const stats = getStudentStats(staff.id, activeTab);
              const studentData = attendanceData[staff.id]?.[activeTab] || {};
      ...
      <div className="flex items-center justify-between mt-4 pt-3 border-t border-gray-700">
        <div className="text-gray-400 text-sm">
          ...
          <span className="text-white">10</span> staffs
        </div>
...
export default StaffAttendanceTransportation;
