...
export default function BookCategoryEditModal({ open, close, data, update }) {
    ...
    <div className="fixed inset-0 bg-black/60 flex justify-center items-center z-50">
      <div className="bg-gray-900 border border-gray-700 rounded-xl w-[450px]">
        <div className="flex justify-between items-center p-5 border-b border-gray-800">
          <h2 className="text-xl text-white">Edit Book Category Name</h2>

          <X onClick={close} className="text-gray-400 cursor-pointer" />
        </div>

        <div className="p-6">
          <label className="text-gray-300">Book Category Name</label>
