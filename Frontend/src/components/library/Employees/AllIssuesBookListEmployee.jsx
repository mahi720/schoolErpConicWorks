...
import ViewBookModalEmployee from "./ViewBookModalEmployee";

export default function AllIssuesBookListEmployee() {
            ...
            {issues.map((item) => (
              ...
              >
                ...
                <td
                  ...
                  className="p-3 text-indigo-400 whitespace-nowrap cursor-pointer hover:underline"
                >
                  {item.title}
                </td>
